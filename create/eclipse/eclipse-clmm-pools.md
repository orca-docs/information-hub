...
NOTE: If you have not added your token to the Orca Token List (see [how to add a token to the Orca Token List](/create/eclipse/eclipse-orca-token-list)), tickArray accounts may need separately initializing for your token to facilitate trade. This can be achieved by creating additional positions. [Orca Splash Pools](/create/eclipse/eclipse-splash-pools) do not require tickArray management, and may be a better option for some users.
